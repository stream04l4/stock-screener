...
// 字段（如 dividend.payout_band_pct / backtest.* / datasource.*）时，兜底 String(v)
// 会渲染成 "[object Object]"。改为**可读摘要**（两处同步：vanilla + Vue strategyMeta）：
...
function compactJson(v, maxDepth) {
  if (Array.isArray(v)) {
